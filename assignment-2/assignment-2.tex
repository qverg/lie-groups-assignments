...
\begin{enumerate}[label=(\roman*)]
    ...
    \begin{equation*}
        ...
        \end{tikzcd}
    \end{equation*}
    commutes. Since $\mathrm{id} : G \to G$ and $p$ are both smooth submersions, $\mathrm{id} \times p$ is a smooth submersion. By (iii), $\alpha$ is smooth, and therefore $p \circ \alpha$ is smooth. According to Lemma 6.13 in the lecture notes, it follows that $\beta$ is smooth.
