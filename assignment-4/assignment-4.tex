...
\begin{enumerate}[label=(\roman*)]
    ...
    \item I will assume the inner product on $V_\pi$ is one which makes $\pi$ unitary, which exists by the compactness of $G$ (Proposition 20.17). By Lemma 22.11, we can identify $\pi$ with $\bigoplus_{\delta \in \hat{G}} m(\delta, \pi) \delta$.
